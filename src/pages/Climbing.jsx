...
export default function Climbing() {
  ...
  if (phase === 'mountain') {
    return (
      <div style={styles.container}>
        <h2 style={styles.pageTitle}>登山</h2>
  ...
  if (phase === 'course') {
    return (
      <div style={styles.container}>
        <h2 style={styles.pageTitle}>{selectedMountain.name} コース選択</h2>
...
const styles = {
  ...
  mountainName: { color: '#fff', fontSize: 18, fontWeight: 'bold' },
  courseCard: {
    display: 'flex',
    flexDirection: 'column',
    gap: 6,
  ...
  courseName: { color: '#fff', fontSize: 16, fontWeight: 'bold' },
  diff: { color: '#f39c12' },
  ...
  cardTitle: { color: '#fff', fontSize: 22, margin: 0 },
